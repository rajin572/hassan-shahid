const ContactMeCard = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 justify-items-center my-20">
      <div className="group flex justify-center items-center flex-col gap-3 text-center border border-secondary-color p-5 rounded duration-500">
        <svg
          ...
          className="lucide lucide-image duration-500 text-secondary-color "
        >
        ...
        <p className="text-secondary-color group-hover:text-primary font-bold duration-500">
          +8801647742754
        </p>
      </div>
      <div className="group flex justify-center items-center flex-col gap-3 text-center border border-secondary-color p-5 rounded duration-500">
        ...
        <p className="text-secondary-color font-bold duration-500">
          Dhaka, Bangladesh
        </p>
      </div>
      <div className="group flex justify-center items-center flex-col gap-3 text-center border border-secondary-color p-5 rounded duration-500">
